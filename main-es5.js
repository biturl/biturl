...
var base_url = "http://bitrl.herokuapp.com/v1/";
// export const base_url = "http://localhost:8081/v1/";
//url
var add_url = "url/add-url";
//contact
var add_contact = "contact/add-contact";
...
var ContactComponent = /** @class */ (function () {
    function ContactComponent(router, _snackbar, contactService, formbuilder) {
        this.router = router;
    ...
    ContactComponent.prototype.saveContact = function () {
        var _this = this;
        this.loading = true;
        this.contactService.addContact(this.contactData).subscribe(function (res) {
            if (res['success']) {
                _this._snackbar.open("Submission successful", "", { duration: 1000 });
            }
            else {
                _this._snackbar.open("Submission failed", "", { duration: 1000 });
            }
            _this.loading = false;
        });
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(urlService, _snackbar, formbuilder) {
    ...
    HomeComponent.prototype.onShort = function () {
        var _this = this;
        this.loading = true;
        this.urlService.addUrl(this.urlData).subscribe(function (res) {
            _this.shortUrl = "https://bitrl.herokuapp.com/" + res['url'];
            _this._snackbar.open("Url has been shorten", "", { duration: 1000 });
            _this.loading = false;
        });
    };
    HomeComponent.prototype.onCopy = function () {
...
var ContactService = /** @class */ (function () {
    ...
    ContactService.prototype.addContact = function (model) {
...
var UrlService = /** @class */ (function () {
    ...
    UrlService.prototype.addUrl = function (url) {
